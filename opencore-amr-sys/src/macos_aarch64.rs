...
extern "C" {
    pub fn Decoder_Interface_init() -> *mut ::std::os::raw::c_void;
}
extern "C" {
    pub fn Decoder_Interface_exit(state: *mut ::std::os::raw::c_void);
}
extern "C" {
...
extern "C" {
    pub fn D_IF_init() -> *mut ::std::os::raw::c_void;
}
extern "C" {
    pub fn D_IF_decode(
        state: *mut ::std::os::raw::c_void,
        bits: *const ::std::os::raw::c_uchar,
        synth: *mut ::std::os::raw::c_short,
        bfi: ::std::os::raw::c_int,
    );
}
extern "C" {
    pub fn D_IF_exit(state: *mut ::std::os::raw::c_void);
}
